            ...
            <Screen>
                ...
                {!tradeDetails['Message'] ?
                    <div className="trade-screen">
                        <div
                            className="header">{tradeDetails['PrimaryCurrencyCode']} to {tradeDetails['SecondaryCurrencyCode']}</div>
                        <div className="tradeTable">
                            <Table tableData={tableBuilder.tradeScreenTable(tradeDetails.Trades)}/>
                        </div>
                    </div> : '404 no such Currency Code'}
            </Screen>
        ) : <Loader/>;
    }
}
